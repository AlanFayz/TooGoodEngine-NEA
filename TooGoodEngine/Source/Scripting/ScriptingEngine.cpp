...
namespace TooGoodEngine {
	...
	void ScriptingEngine::Init(const std::filesystem::path& path)
	{
		...
		s_Data->MethodDefinitions[44] = { "internal_create_perspective_camera_controller",   PythonBindings::InternalCreatePerspectiveCameraController,   METH_VARARGS, "internal" };
		...
		s_Data->MethodDefinitions[46] = { "internal_set_aspect_ratio_perspective_camera_controller",	 PythonBindings::InternalSetAspectRatioPerspectiveCameraController,   METH_VARARGS, "internal" };
		...
		s_Data->MethodDefinitions[50] = { "internal_update_rotation_perspective_camera_controller",	 PythonBindings::InternalUpdateRotationPerspectiveCameraController,   METH_VARARGS, "internal" };


		// ---- END ----
		s_Data->MethodDefinitions[51] = { nullptr, nullptr, 0, nullptr };
